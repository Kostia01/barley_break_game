...
#include <memory>
#include "../../15-puzzleQt-master/gamecontroller.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_GameController_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_GameController_t qt_meta_stringdata_GameController = {
    {
QT_MOC_LITERAL(0, 14), // "GameController"
QT_MOC_LITERAL(15, 8), // "getModel"
QT_MOC_LITERAL(24, 10), // "GameBoard*"
QT_MOC_LITERAL(35, 0) // ""

    },
    "GameController\0getModel\0GameBoard*\0"
};
...
void GameController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: { GameBoard* _r = _t->getModel();
...
const QMetaObject GameController::staticMetaObject = { {
    ...
    qt_meta_stringdata_GameController.offsetsAndSize,
